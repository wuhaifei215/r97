...
class H88PayController extends PayController
{
    private $code = '';
    ...
    public function Pay($array)
    {
        ...
        if($ans['status'] === 1){
            $payurl = $site . 'PayPage.html?sid=' . $return['orderid'] . '&amount=' . $return['amount']. '&qrcode=' .$ans['data']['pay_url']['qrcode'];
                $return_arr = [
                    'status' => 'success',
                    'H5_url' => $payurl,
                    'QRcode' => $ans['data']['pay_url']['qrcode'],
                    'pay_orderid' => $orderid,
